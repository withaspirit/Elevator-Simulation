...
public class ElevatorSelectionTest {
    ...
    static void oneSetUp() {
        ...
        Structure structure = new Structure(10, 2, 1000, 100);

        //Setup a ElevatorSubsystem
        elevatorSubsystem = new ElevatorSubsystem();
        elevator1 = new Elevator(1, elevatorSubsystem, structure);
        elevator2 = new Elevator(2, elevatorSubsystem, structure);
    ...
    void testSelectingIdleElevators() {
        ...
        assertEquals(1.1, monitorList.get(0).getQueueTime());
        ...
        assertEquals(3.2, monitorList.get(1).getQueueTime());
