...
public class ElevatorSelectionTest {
    ...
    void testSelectingIdleElevators() {
        ...
        assertEquals(elevator1.getRequestQueue().getExpectedTime(elevator1.getElevatorMonitor().getCurrentFloor()), 0.0);
        assertEquals(elevator2.getRequestQueue().getExpectedTime(elevator2.getElevatorMonitor().getCurrentFloor()), 0.0);
