...
public class Elevator implements Runnable, SubsystemPasser {
	...
	public ElevatorMonitor makeElevatorMonitor() {
		return new ElevatorMonitor(elevatorNumber, currentFloor, serviceDirection, motor.getMovementState(), requestQueue.isEmpty(), requestQueue.getExpectedTime(currentFloor));
	}
